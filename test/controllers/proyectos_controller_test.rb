...
class ProyectosControllerTest < ActionController::TestCase
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post :create, proyecto: { cliente: @proyecto.cliente, gerente: @proyecto.gerente, lider: @proyecto.lider, user_id: @proyecto.user_id }
    end
  ...
  test "should update proyecto" do
    patch :update, id: @proyecto, proyecto: { cliente: @proyecto.cliente, gerente: @proyecto.gerente, lider: @proyecto.lider, user_id: @proyecto.user_id }
    assert_redirected_to proyecto_path(assigns(:proyecto))
  end
